...
│   │   ├── section.js                 # Вкладка правил/секций (4 логические вкладки: Основные, Правила, Устройства, Дополнительно)
...
├── tests/                             # Тестовый набор (68 изолированных bash-тестов и js-хелперов)
...
- **Консолидация тестового набора**:
  - 6 устаревших тестов проверки миграции с shell на ucode (`*_owner.sh`) консолидированы в единый быстрый смоук-тест `tests/backend_ownership_smoke.sh`, исключающий дублирование тестовых окружений и ускоряющий прогон CI в GitHub Actions.
