...
import { P99ShellMethods } from '../index';

describe('P99ShellMethods.componentAction', () => {
  beforeEach(() => {
    vi.useFakeTimers();
  ...
  it('does not fail P99 self-update when status polling disappears after package replacement', async () => {
    ...
    const responsePromise = P99ShellMethods.waitComponentActionJob(
      'job-1',
      'p99',
      'install',
      '0.7.17.11',
    ...
    await expect(responsePromise).resolves.toEqual({
      ...
      data: {
        ...
        component: 'p99',
        action: 'install',
        message: 'P99 has been installed',
  ...
  it('returns the backend component action start error message', async () => {
    ...
    await expect(
      P99ShellMethods.componentActionStart('zapret', 'install'),
    ).resolves.toEqual({
      success: false,
