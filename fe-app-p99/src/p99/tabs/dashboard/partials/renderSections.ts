...
interface IRenderSectionsProps {
  ...
  onShowUrlTestInfo: (outbound: P99.Outbound) => void;
  onShowPriorityInfo: (outbound: P99.Outbound) => void;
  onUpdateSubscription: (section: P99.OutboundGroup) => void;
...
function renderSubscriptionMetadata(
  metadata: P99.SubscriptionMetadata | undefined,
) {
...
function renderDefaultState({
  ...
  function renderOutbound(outbound: P99.Outbound) {
