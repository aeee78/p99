...
#cbi-${P99_CBI_PREFIX}-dashboard-_mount_node > .cbi-value-title {
    display: none;
}

#cbi-${P99_CBI_PREFIX}-dashboard-_mount_node > .cbi-value-field {
    margin-left: 0;
    width: 100%;
}

#cbi-${P99_CBI_PREFIX}-dashboard-_mount_node > div {
    width: 100%;
}

#cbi-${P99_CBI_PREFIX}-dashboard > h3 {
    display: none;
}
