...
export async function runZapret2Check() {
  ...
  const items: Array<IDiagnosticsChecksItem> = [
    ...
    },
    {
      ...
      key: hasZapret2Rules
        ? p99RuntimeReady
          ? _('P99-managed nfqws2 runtime is ready')
          : _('P99-managed nfqws2 runtime is not ready')
        : unexpectedRuntime
          ? _('Unexpected P99-managed nfqws2 runtime is running')
          : _('P99-managed nfqws2 runtime is not running'),
    ...
    },
    {
      ...
      key: standaloneServiceRunning
        ? hasZapret2Rules
          ? _('Standalone Zapret2 is active together with P99 Zapret2 rules')
