...
export const styles = `
#cbi-${P99_CBI_PREFIX}-monitoring-_mount_node {
    margin: 16px 0 22px;
    padding: 0;
}

#cbi-${P99_CBI_PREFIX}-monitoring-_mount_node > .cbi-value-title {
    display: none;
}

#cbi-${P99_CBI_PREFIX}-monitoring-_mount_node > .cbi-value-field {
    margin-left: 0;
    width: 100%;
}

#cbi-${P99_CBI_PREFIX}-monitoring-_mount_node > div {
    width: 100%;
}

#cbi-${P99_CBI_PREFIX}-monitoring > h3 {
    display: none;
}
