...
// eslint-disable-next-line @typescript-eslint/no-namespace
export namespace P99 {
  // Available commands:
  // start                   Start p99 service
  // stop                    Stop p99 service
  // reload                  Reload p99 configuration
  // restart                 Restart p99 service
  // enable                  Enable p99 autostart
  // disable                 Disable p99 autostart
  // uninstall               Remove p99 files installed outside opkg/apk
  // main                    Run main p99 process
  ...
  // check_logs              Show p99 logs from system journal
  ...
  // show_config             Display current p99 configuration
  // show_version            Show p99 version
  // show_sing_box_config    Show sing-box configuration
  // show_sing_box_version   Show sing-box version
  // get_status              Get p99 service status
