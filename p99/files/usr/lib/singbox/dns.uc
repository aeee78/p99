...
const DNS_FAILOVER_STATE_FILE = getenv("P99_DNS_FAILOVER_STATE_FILE") || "/var/run/p99/dns-failover.json";
const DNS_HEALTH_ADDRESS = getenv("P99_DNS_HEALTH_ADDRESS") || "127.0.0.42";
const DNS_HEALTH_PORT_BASE = int(getenv("P99_DNS_HEALTH_PORT_BASE") || "10053");
