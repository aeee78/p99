...
const NFT_PORT_SET_NAME = getenv("NFT_PORT_SET_NAME") || "p99_ports";
...
function service_listen_address_value(settings) {
    ...
    log_message("Failed to determine the listening IP address. Please open an issue to report this problem: https://github.com/aeee78/p99/issues", "error");
    return "";
}
