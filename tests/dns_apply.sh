...
APPLY="$ROOT_DIR/p99/files/usr/lib/dns/apply.uc"
UCODE_LIB="$ROOT_DIR/p99/files/usr/lib"
WORK_DIR="$(mktemp -d)"
...
p99.settings.shutdown_correctly=1
EOF_STATE
...
assert_value 'dhcp.@dnsmasq[0].p99_server' '1.1.1.1 8.8.8.8'
assert_value 'dhcp.@dnsmasq[0].noresolv' '1'
assert_value 'dhcp.@dnsmasq[0].p99_noresolv' '0'
assert_value 'dhcp.@dnsmasq[0].cachesize' '0'
assert_value 'dhcp.@dnsmasq[0].p99_cachesize' '150'
...
assert_absent 'dhcp.@dnsmasq[0].p99_server'
assert_absent 'dhcp.@dnsmasq[0].p99_noresolv'
assert_absent 'dhcp.@dnsmasq[0].p99_cachesize'
assert_log_contains 'commit dhcp'
assert_dnsmasq_restarted
...
dhcp.@dnsmasq[0].p99_server=1.1.1.1 8.8.8.8
dhcp.@dnsmasq[0].p99_notinterface=wan docker
dhcp.@dnsmasq[0].p99_noresolv=1
dhcp.@dnsmasq[0].p99_cachesize=0
dhcp.p99.interface=br-lan guest
...
assert_value 'dhcp.@dnsmasq[0].cachesize' '0'
assert_absent 'dhcp.@dnsmasq[0].p99_server'
assert_absent 'dhcp.@dnsmasq[0].p99_notinterface'
assert_absent 'dhcp.@dnsmasq[0].p99_noresolv'
assert_absent 'dhcp.@dnsmasq[0].p99_cachesize'
assert_absent 'dhcp.p99.interface'
assert_log_contains 'commit dhcp'
